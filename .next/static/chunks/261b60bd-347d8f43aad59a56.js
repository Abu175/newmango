"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[15],{50843:function(e,t,r){r.d(t,{Y:function(){return eQ},Z:function(){return e0},d:function(){return tU},p:function(){return ru}});var n,i=r(21480),s=r(32723),a=r(73693),o=r(65980);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function u(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${i.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,r=!1){if((0,i.rh)(e.app))return Promise.reject(m(e));let n="signIn",s=await e5(e,n,t),a=await e3._fromIdTokenResponse(e,n,s);return r||await e._updateCurrentUser(a.user),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
