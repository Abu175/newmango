...
export default function SignInToEditor() {
  ...
  const handleLogin = (userData: { email: string; name: string }, authToken?: string) => {
    console.log("SignIn handleLogin called with:", userData, authToken);
    setUser(userData);
        ...
        <div style={neumorphicStyle} className="p-8">
          <div className="text-center mb-8">
            ...
            <p style={{color: 'var(--text-color)', opacity: 0.8}}>
              Connect your account to use Codilore features in your editor
            </p>
          </div>
